    		...
    		<div class="card">
    			<div class="header">
	                <h2>
                        ...
                        <div class="body">
                            <form method="POST" action="/vulcanizator/raport-zilnic/{{$vulcanizator->id}}">
                                    {{ csrf_field() }}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody><?php $suma = 0; ?>
                                     @foreach ($vulcanizator->Vulcanizare as $value) 
                                       <tr onclick="window.location='/vulcanizare/show/{{$value->id}}'">
                                            <td>{{$value->id}}</td>
