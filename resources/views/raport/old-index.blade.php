  ...
  <div class="body">
    <form method="POST" action="/raport">
                                      {{ csrf_field() }}
   ...
   <table>
            <tr> 
                  <?php foreach ($mecanics as $mecanic) { ?>
                          <th><h3><?php echo $mecanic->nume .' '. $mecanic->prenume ?>
                              <span style="font-size: 12px; font-weight: normal; vertical-align: middle;"> (Service)</span>:</h3></th>
                  <?php $suma_mecanic = 0;
            ...
            <?php foreach ($reglarea_mecanics as $reglarea_mecanic) { ?>
                            <tr> 
                              <td><h3><?php echo $reglarea_mecanic->nume .' '. $reglarea_mecanic->prenume ?>
                              <span style="font-size: 12px; font-weight: normal; vertical-align: middle;"> (Reglarea)</span>:</h3></td>

                              <?php 
                               foreach ($reglarea_mecanic->ReglareaUnghiului as $value) {
            ...
            <?php foreach ($vulcanizators as $vulcanizator) { ?>
                            <tr>
              <td><h3><?php echo $vulcanizator->nume ?>
                              <span style="font-size: 12px; font-weight: normal; vertical-align: middle;"> (Vulcanizare)</span>:</h3></td>
        ...
        $suma_reglarea = 0;
                            ...
                            ?> 
                  <h3><?php echo $suma_serviciu + $suma_reglarea;?></h3> 
              </td>
            </tr>
