                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <tr> 
                                            ...
                                            <td>{{$service->pret}} lei</td>
                                            <td>{{$service->suma}} lei</td>
                                            <td>{{$service->pret_lucru}} lei</td>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td style="font-weight: bold;">{{$service->suma}} lei</td>
                                            <td style="font-weight: bold;">{{$service->pret_lucru}} lei</td>
