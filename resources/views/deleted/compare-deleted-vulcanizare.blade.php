            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <b>Nr masinei : <span>{{$deletedVulcanizare->nr_masina}}</span> </b>
                            </h2>
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable">
                                    <thead> <h4>Actul sters nr. <span style="color:#d01a44">{{$deletedVulcanizare->old_parent_id}}</span>  la data de : <span style="color:#d01a44">{{$deletedVulcanizare->created_at}}</span> </h4>
                                    ...
                                    <tbody>
                                        <tr>  
                                            <td>{{$deletedVulcanizare->Beneficiar->nume}}</td>
                                            <td>{{$deletedVulcanizare->nr_masina}}</td>
                                            <td>{{$deletedVulcanizare->suma}} lei</td>
                ...
                <?php if($deletedVulcanizare){ ?>
                    <table class="table table-bordered table-striped table-hover dataTable">
                                    <thead> <h4>Actul nou nr. <span style="color:#d01a44">{{$vulcanizare->id}}</span> la data de : <span style="color:#d01a44">{{$vulcanizare->created_at}} </span></h4>
                                        <tr>
                                            <th>Beneficiar</th>
                                            <th>Nr. masina</th>
                                            <th>Pret lucru</th>
                                    ...
                                    <tbody>
                                        <tr onclick="window.location='/vulcanizare/show/{{$vulcanizare->id}}'">
                                            <td>{{$vulcanizare->Beneficiar->nume}}</td>
                                            <td>{{$vulcanizare->nr_masina}}</td>
                            ...
                            <h2>Actul sters - Actul actual = 
                                ...
                                <?php echo $deletedVulcanizare->suma - $vulcanizare->suma; ?> lei 
                                </span>
                            </h2>
